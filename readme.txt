...
* Minor CSS changes to support the new Wordpress Theme.

= 2.8.1 =
Maintenance release:
* Tested with Wordpress 4.4
* Added Norwegian Bokmål as translation as well, we only had Nynorsk before.

= 2.8.0 =
* This is also the last planned release of this plugin.
* Resolved major cache-bug in API result. This should resolve image-issues.

= 2.7.5 =
* This is the last planned release of this plugin.
* Bumped the limit of max amount of listings from 50 to 1000.
